...
$.lang.register('rafflesystem.open.usage', 'Verwendung: !raffle open [Beitrittsgebühr] [Schlüsselwort] [Länge der Verslosung in Minuten] [-usetime / -usepoints / -followers | -subscribers]. [keyword] erforderlich.');
...
$.lang.register('rafflesystem.winner', 'Der/Die GewinnerIn dieser Verlosung ist $1!');
$.lang.register('rafflesystem.whisper.winner', 'Du hast die Verlosung im Kanal $1 gewonnen!');
$.lang.register('rafflesystem.whisper.winner.repick', 'Du wurdest als neue/r GewinnerIn der Verlosung im Kanal $1 ausgewählt!');
$.lang.register('rafflesystem.repick.error', 'Es sind keine weiteren TeilnehmerInnen in der TeilnehmerInnenliste vorhanden.');
$.lang.register('rafflesystem.repick', 'Neue/r GewinnerIn ist $1!');
