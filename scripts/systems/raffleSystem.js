...
(function() {
    var entries = [],
        ...
        raffleMessage = $.getSetIniDbString('raffleSettings', 'raffleMessage', 'Eine Verlosung ist noch offen! Schreibe (keyword) um mit zu machen. Es machen schon (entries) Nutzer mit.'),
