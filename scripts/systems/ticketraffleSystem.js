(function() {
    var cost = 0,
        ...
        raffleMessage = $.getSetIniDbString('settings', 'traffleMessage', 'Eine Verlosung ist noch offen! Schreibe !tickets (amount) um mit zu machen. (entries) Nutzer nehmen schon daran Teil.'),
